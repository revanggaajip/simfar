...
// route since we don't have to scan directories.
    ...
    $routes->group('penerimaan', function($routes) {
        ...
        // $routes->get('edit/(:any)', 'PenerimaanController::edit/$1', ['as' => 'penerimaan.edit']);
        $routes->put('update/(:any)', 'PenerimaanController::update/$1', ['as' => 'penerimaan.update']);
        $routes->delete('delete/(:any)', 'PenerimaanController::delete/$1', ['as' => 'penerimaan.delete']);
        $routes->put('detail/update/(:any)/(:any)', 'PenerimaanController::updateDetail/$1/$2', ['as' => 'penerimaan.updateDetail']);
        $routes->delete('detail/delete/(:any)/(:any)', 'PenerimaanController::deleteDetail/$1/$2', ['as' => 'penerimaan.deleteDetail']);
